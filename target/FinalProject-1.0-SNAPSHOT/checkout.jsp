<%-- 
    Document   : cart
    Created on : 02-Oct-2023, 5:25:14 pm
    Author     : Smit Soni
--%>
                        ...
                        <div class="card-body">
                            <form action="order" method="post">
                                ...
                                <div class="form-group col-md-6">
                                  ...
                                  <input type="text" name="username" class="form-control" id="inputEmail4" placeholder="Name" value="${userobj.name}" required>
                                </div>
                                <div class="form-group col-md-6">
                                  <label for="inputPassword4">Email</label>
                                  <input type="email" name="email" class="form-control" id="inputPassword4" placeholder="Email" value="${userobj.email}" required>
                                </div>
                              </div>
                                ...
                                <div class="form-group col-md-6">
                                  ...
                                  <input type="number" name="phno" class="form-control" id="inputEmail4" placeholder="Phone Number" value="${userobj.phno}" required>
                                </div>
                                <div class="form-group col-md-6">
